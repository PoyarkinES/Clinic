...
{
    [DataContract]
    public class CreateCountryCommand(Guid commandId, string isoCode, string fullName, string shortName, string alfa2Code, string alfa3Code) : IRequest<IResponse<CountryDto>>
    {
        [DataMember]
